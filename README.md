...
<p>זיהוי תווים אופטי, או OCR בלעז (Optical Character Recognition), היא טכנולוגיה להמרת תמונה, טקסט מודפס וכתב יד שנסרקו על ידי סורק, למסמך תמליל ממוחשב. זיהוי תווים אופטי הוא שלב מרכזי בתהליך הדיגיטציה של טקסטים ומהווה תנאי הכרחי לכל מחקר חישובי של טקסטים. בסופו של התהליך קבצי תמונה או PDF הופכים לחפישים וניתנים לעריכה כקבצי טקסט או בתוכנות כדוגמת Word.</p>
